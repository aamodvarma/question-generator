...
\begin{tikzpicture}[remember picture,overlay]
    ...
    % \filldraw[black, opacity = 0.65] (-3, 1.25) rectangle (\paperwidth, 1.15);
    \draw[] (.1,-0.3) node[right]{\begingroup{\fontfamily{qhv} \fontsize{28pt}{12pt}\selectfont{\color{black} Exam 3 Sample Exams}}\endgroup};
...
\fi
    \draw[] (.2,-5.8) node[right]{{\fontfamily{qhv}\selectfont {\Large \color{black} Last Compiled on \today. }}};        
