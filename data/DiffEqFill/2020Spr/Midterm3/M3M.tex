...
\newcommand{\TestName}{Midterm 3 MakeUp}
\newcommand{\TestDate}{Apr 2 at 8:00 am}
\newcommand{\TestTime}{120 minutes}
\newcommand{\Duration}{120  }
\newcommand{\Points}{35 }
...
\begin{questions}
    ...
    % $\displaystyle Y = \frac{2s+1}{s^2-2s+2}$. % M 5.3#15
...
\newpage \InitialsRight
    ...
    $\displaystyle dx/dt = x-y, \quad dy/dt = x-3y+xy - 3$. % M HW7.2#3
