...
\newcommand{\TestName}{Midterm 2 MakeUp}
\newcommand{\TestDate}{on or before Mar 3}
...
\begin{questions}
    ...
    \question[4] Determine all values of $\alpha$, if any, for which all solutions tend to infinity as $t\to\infty$. $$y'' - (2\alpha - 1) y' + (\alpha^2-\alpha+1) y = 0, \quad \alpha \in \mathbb R$$ \vspace{7cm}  % 4.3.47
...
\Scratch
    ...
    \newpage    \InitialsLeft
        ...
        \question[10] Consider a lattice with $3$ lattice points, as in the figure below. 
